...
//func (conn *Conn) fetchResultsFunc(func (value interface{}) error) ([]*Result, error) {
func (conn *Conn) fetchResultsDrew(process func(int, int, []interface{}) error) ([]*Result, error) {
	results := make([]*Result, 0)
	setIndex := 0
	for {
		erc := C.dbresults(conn.dbproc)
